...
consumer.subscriptions.create("TempReadingsChannel", {
  ...
  received(data) {
    ...
    if (window.location.pathname === '/temp_readings') { // only refresh on this page because the settings/monitors pages don't need this and it would disrupt editing settings/monitors
